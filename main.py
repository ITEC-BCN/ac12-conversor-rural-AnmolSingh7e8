...
def on_on_overlap(npc, trigger):
    global talking
    npc.say_text("Pulsa A", 200)
    if not (talking):
        npc.say_text("Pulsa A", 200)
        talking = True
...
def create_npc():
    ...
    npc_trigger.set_position(npc2.x, npc2.y)
...
npc_trigger = sprites.create(img("""
        ...
        """),
    SpriteKind.player)
controller.move_sprite(npc_trigger, 100, 100)
# Crear NPC y jugador
create_npc()
